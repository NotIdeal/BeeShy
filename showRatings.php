...
if($_COOKIE['how'] == 'mix'){
    $tag ="sortBy=mix&";
    $sql = "SELECT * FROM users ORDER BY  post_votes * 4 + comment_votes DESC LIMIT " . $start_from . ", " . $per_page.";";
}
if($_COOKIE['how'] == 'com'){
    $tag ="sortBy=comm&";
    $sql = "SELECT * FROM users ORDER BY  comment_votes DESC LIMIT " . $start_from . ", " . $per_page.";";
}
if($_COOKIE['how'] == 'post'){
    $tag ="sortBy=post&";
    $sql = "SELECT * FROM users ORDER BY  post_votes  DESC LIMIT " . $start_from . ", " . $per_page.";";
}
